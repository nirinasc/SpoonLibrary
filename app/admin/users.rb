...
# end
    ...
    #form
    permit_params do 
        permitted = [:firstname, :lastname, :email, :username, :role, :active, :country_code, :city, :address, :zip_code, :phone]
        permitted += [:password, :password_confirmation] if params[:action] == 'create' && current_user.admin?
        permitted
    end
