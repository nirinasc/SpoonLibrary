...
filter :name
filter :country_code, label: "Country", as: :select, collection: ISO3166::Country.countries.sort_by(&:name).collect { |country| [ country.name, country.alpha2 ] }, include_blank: true
