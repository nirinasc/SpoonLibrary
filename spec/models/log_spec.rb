...
RSpec.describe Log, type: :model do
  ...
  let(:book) { FactoryBot.create(:book, library: FactoryBot.create(:library)) }
  let(:book_loan) { FactoryBot.build(:book_loan, user: user, book: book) }
  let(:book_return) { FactoryBot.build(:book_return, user: user, book: book, loan: book_loan) }
